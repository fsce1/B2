Shader "Cityrobo/ScopeSimplifiedMK2" {
    Properties{
        [NoScaleOffset]
        _MainTex("Camera Render Texture", 2D) = "white" {}
        _VignetteRadius("Vignette Radius", Range(0, 4)) = 1
        _VignetteSmoothness("Vignette Smoothness", Range(0, 4)) = 0.25
        [Toggle(SECONDARY_VIGNETTE)] 
        _SecondaryVignetteBool("Has secondary Vignette? ", Float) = 0
        _SecondaryVignetteRadius("Secondary Vignette Radius", Range(0, 4)) = 1
        _SecondaryVignetteSmoothness("Secondary Vignette Smoothness", Range(0, 4)) = 0.25
        ...
        Pass
        {
            ...
            fixed _VignetteRadius, _VignetteSmoothness, _SecondaryVignetteRadius, _SecondaryVignetteSmoothness;
            fixed _EyeRelief;
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                _VignetteRadius -= camDist/_EyeRelief;
                #else
                _VignetteRadius -= 1;
                #endif
                ...
                //_SecondaryVignetteRadius /= camDist;
                //_SecondaryVignetteSmoothness /= camDist;
